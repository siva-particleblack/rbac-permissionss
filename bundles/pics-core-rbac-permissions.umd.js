    ...
    ***************************************************************************** */
    ...
    var PermissionsComponent = /** @class */ (function () {
        ...
        PermissionsComponent.prototype.selectParent = function () {
            this.allPages = this.pages.filter(function (a) { return (a === null || a === void 0 ? void 0 : a.menutype) == 'parent'; });
        };
        PermissionsComponent.prototype.selectPage = function () {
            this.allPages = this.pages.filter(function (a) { return (a === null || a === void 0 ? void 0 : a.menutype) == 'page'; });
        };
